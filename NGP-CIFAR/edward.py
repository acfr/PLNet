# 
# code adopted from https://github.com/google/edward2 to bypass the compatability issues with TensorFlow
#
import math
...
def Beta(alpha, beta, sample_shape):
